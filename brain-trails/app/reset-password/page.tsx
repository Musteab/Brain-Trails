        ...
        <div className="relative z-10">
          {isSuccess ? (
            ...
            >
              ...
              <Link
                href="/login"
                className="text-violet-300 hover:text-white font-bold text-sm transition-colors"
              >
                Go to Login Now →
              </Link>
            </motion.div>
                ...
                <div className="space-y-4">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3.5 bg-white/10 border-2 border-white/10 text-white rounded-2xl focus:outline-none focus:border-emerald-400 focus:bg-white/20 transition-all placeholder:text-indigo-200/50"
