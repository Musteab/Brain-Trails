...
export default function CommandPalette() {
  ...
  const actions: CommandAction[] = useMemo(
    () => [
      ...
      { id: "nav-codex",        label: "Codex",         icon: <Compass className="w-4 h-4" />,     category: "navigate", action: () => router.push("/codex") },
      ...
      { id: "nav-flashcards",   label: "Decks",         icon: <Layers className="w-4 h-4" />,      category: "navigate", action: () => router.push("/flashcards") },
      { id: "nav-trials",       label: "Trials",        icon: <GraduationCap className="w-4 h-4" />, category: "navigate", action: () => router.push("/quiz") },
      { id: "nav-achievements", label: "Trophies",      icon: <Trophy className="w-4 h-4" />,      category: "navigate", action: () => router.push("/achievements") },
