...
export default function AccountTab({ account }) {
  ...
  const updateUsernameMutation = useMutation({
    mutationFn: async (username) => {
      const res = await api.patch('/api/settings/account/username', { username });
      return res.data;
    },
    onSuccess: () => {
  ...
  const updateEmailMutation = useMutation({
    mutationFn: async (email) => {
      const res = await api.patch('/api/settings/account/email', { email });
      return res.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['settings', 'account'] });
  ...
  const updatePasswordMutation = useMutation({
    mutationFn: async ({ current_password, new_password }) => {
      const res = await api.patch('/api/settings/account/password', {
        current_password,
        new_password,
      });
      return res.data;
